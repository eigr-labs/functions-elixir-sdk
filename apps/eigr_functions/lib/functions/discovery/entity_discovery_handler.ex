defmodule Functions.EntityDiscovery.Handler do
  @moduledoc false
  use GenServer
  require Logger
  ...
  def handle_call({:proxy_info, proxy_info}, _from, entity_spec) do
    ...
    service_info =
      Cloudstate.ServiceInfo.new(
        ...
        support_library_name: Application.spec(:eigr_functions)[:description],
        support_library_version: Application.spec(:eigr_functions)[:vsn],
