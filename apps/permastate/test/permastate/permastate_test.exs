defmodule ActionTest do
  ...
  test "simple unary call" do
    ...
    assert {:reply, %Pong{name: "Anakin Skywalker"}} =
             Permastate.Action.Protocol.Unary.handle_unary(unary_action, %Ping{
  ...
  test "unary response with SideEffects" do
    ...
    assert {:reply, %Ping{name: "Pong"},
            %Permastate.SideEffect{service_name: "test_service", command_name: "echo"}} =
             Permastate.Action.Protocol.Unary.handle_unary(unary_action, %Pong{})
  end
  ...
  test "streamin simple call" do
    ...
    assert %Ping{name: "Pooong"} =
             Permastate.Action.Protocol.StreamIn.handle_stream_in(stream_in_action, stream)
  end
  ...
  test "multi request types calls" do
    ...
    assert {:reply, %Ping{name: "Pong"},
            %Permastate.SideEffect{service_name: "test_service", command_name: "echo"}} =
             Permastate.Action.Protocol.Unary.handle_unary(multi_action, %Pong{})
    ...
    assert %Ping{name: "Pooong"} =
             Permastate.Action.Protocol.StreamIn.handle_stream_in(multi_action, stream)
  end
end
